const universityData = [
  {
    ...
    contact: "+233-3220-61831",
    accreditation: "NAB (National Accreditation Board)",
    studentPopulation: "87,975+",
    admissionRequirement:
      "Minimum aggregate of 8-24 in relevant subjects, WASSCE results required",
    facilities:
  ...
  },
  {
    ...
    contact: "+233-302-213850-3",
    accreditation: "NAB (National Accreditation Board)",
    studentPopulation: "67,914+",
    admissionRequirement:
      "Minimum aggregate of 6-36 in relevant subjects, WASSCE results required",
    facilities:
      "University of Ghana Library, sports complex, medical center, student hostels, ICT centers",
    gallery: [
      "https://th.bing.com/th/id/R.e018322a40043df9f1297a6a00d9d7cf?rik=NKkKTeuuLPrUDQ&pid=ImgRaw&r=0",
      "https://ghanaremembers.com/storage/public/university-of-ghana-1.jpg",
      "https://www.edc-ent.com/wp-content/uploads/2021/07/343434.jpg",
    ],
  },
  {
    id: "ucc",
  ...
  },
  {
    ...
    contact: "+233-33-2092-695",
    accreditation: "NAB (National Accreditation Board)",
    studentPopulation: "15,621+",
    admissionRequirement:
  ...
  },
  {
    ...
    contact: "+233-30-393-7544",
    accreditation: "NAB (National Accreditation Board)",
    studentPopulation: "26,703+",
    admissionRequirement:
